        ...
        <div className="about__content">
          <div className="about__leftContent">
            ...
            <p className="about__paragraphe">
              ...
              come together and get to know one another, all while having a good
              time.
            </p>
          </div>
        ...
        <div className="about__main2">
          <div className="about__content">
            ...
            <div className="about__leftContent">
              ...
              <img src={TitleBorder} className="about__titleBorder" />
              <p className="about__paragraphe">
                As a small Mother & Son-owned establishment, we aim to provide a
                <strong> friendly relaxing atmosphere</strong>
