      ...
      <div className="homepage__content">
        ...
        <div className="welcome__content">
          <div className="content_welcome">
            ...
            />
            <p className="homepage__services__desc">
              Karma’s House of Spirit’s is Redding’s newest 21 & older bar.
              Fully remodeled from the ground up, featuring 7 flat-screen TVs,
              Two pool tables, a jukebox, and{" "}
              <strong>
              ...
              <strong>Sunday Bruch with All Day Happy Hour.</strong> We’re
              always hosting fun events like Karaoke, all sporting events, NFL,
              MLB, Nascar, played over the built-in Bose entertainment system.
